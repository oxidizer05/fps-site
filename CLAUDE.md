...
- На `join.html` про ссылку поддержки сказано **вскользь**: одна фраза в шаге верификации + вопрос в FAQ, на обоих языках. Сознательно НЕ выносим это в лендинг, кнопки-призывы и сам рейтинг: как приманка «тут можно получать деньги» приводит людей с другой мотивацией и обещает то, что у большинства не сбудется (аудитория маленькая). Но и прятать нельзя — человек решает, проходить ли верификацию с фото, и вправе знать, что за ней следует.
